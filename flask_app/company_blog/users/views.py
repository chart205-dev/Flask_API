...
from company_blog.users.forms import RegistrationForm, LoginForm, Updateuserforom
...
@users.route('/<int:user_id>/delete', methods=["PoST","GET"])
@login_required
def delete_user(user_id):
	...
	return redirect(url_for('users.users.user_maintenance'))